...
#     f.seek(10)
#     # Tells the current byte position which is 10 here
#     print(f.tell())
...
#         self._value = value
#     show = lambda self: print(f"Value is {self._value}")
...
# e1 = Employee("Alqama", 405)
# e1.showDetails()
# e2 = Programmer("Alkma", 410)
# e2.showDetails()
# e2.showLanguage()
...
class Math:
  ...
  @staticmethod
  def add(a, b): # self arg not needed here.
      return a + b
